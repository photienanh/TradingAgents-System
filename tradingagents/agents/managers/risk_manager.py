...
def create_risk_manager(llm):
    def risk_manager_node(state) -> dict:
        ...
        prompt = (
            ...
            f"## KẾT QUẢ NGHIÊN CỨU VÀ KẾ HOẠCH CỦA RESEARCH TEAM\n{sanitize_for_prompt(research_plan)}\n\n"

            f"## KẾ HOẠCH TỪ TRADER\n{sanitize_for_prompt(trader_plan)}\n\n"
            ...
            "Mỗi analyst có xu hướng cố hữu - hãy đánh giá CHẤT LƯỢNG BẰNG CHỨNG, không phải chiều hướng của analyst.\n\n"

            "## QUY TRÌNH RA QUYẾT ĐỊNH\n"
            "Bước 1: Xác định luận điểm có bằng chứng cụ thể nhất từ mỗi bên\n"
            "Bước 2: Đối chiếu với các kế hoạch đầu tư\n"
