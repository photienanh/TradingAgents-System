    ...
    def trader_node(state):
        ...
        if horizon == "short":
            ...
            output_format = (
                ...
                "- **Vùng giá thực thi (Execution Zone):** [Khoảng giá Mua/Bán cụ thể trích xuất từ hỗ trợ/kháng cự]\n"
                "- **Mục tiêu chốt lời (Take Profit):** [Chỉ ghi nếu lệnh là MUA]\n"
                "- **Ngưỡng cắt lỗ (Stop Loss):** [Mức giá cắt lỗ để bảo vệ vốn]\n"
                "- **Tỷ lệ Rủi ro/Lợi nhuận (Risk/Reward Ratio):** [VD: 1:2, 1:3... tính toán từ Entry, TP và SL]\n"
                "- **Tỷ trọng vốn (Position Size):** [Đề xuất % giải ngân]\n\n"
            ...
            output_format = (
                ...
                "- **Vùng giá gom mua (Accumulation Zone):** [Khoảng giá có rủi ro thấp nhất]\n"
                "- **Định giá mục tiêu (Target Valuation):** [Mức giá kỳ vọng]\n"
                "- **Điểm vô hiệu hoá (Invalidation Point):** [Giá cắt lỗ hoặc điều kiện cơ bản nào bị phá vỡ]\n"
                "- **Tỷ trọng vốn (Position Size):** [Mức phân bổ tối đa cho danh mục, VD: Tối đa 20% NAV]\n\n"
                "#### 3. Căn cứ thiết lập thông số\n"
