...
def create_safe_debator(llm):
    ...
    Nhiệm vụ của bạn là phản biện chủ động các luận điểm của Risky Analyst và Neutral Analyst, làm rõ nơi họ có thể bỏ sót đe dọa tiềm ẩn hoặc chưa đặt trọng tâm vào tính bền vững. Nếu tín hiệu AlphaGPT cho thấy hướng short, đây là bằng chứng định lượng hỗ trợ quan điểm thận trọng của bạn. Hãy phản hồi trực tiếp từng điểm của họ, dựa trên các nguồn dữ liệu sau để xây dựng lập luận thuyết phục cho một phương án điều chỉnh theo hướng rủi ro thấp hơn:
