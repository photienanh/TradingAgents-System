...
class AgentState(MessagesState):
    ...
    trading_horizon:     Annotated[str, "Trading horizon: 'short' (swing 2-5 days) or 'long' (medium-long term)"]
    ...
    quant_report:       Annotated[str, "Quantitative alpha signal report from Alpha Analyst"]
